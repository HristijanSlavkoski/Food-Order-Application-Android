...
public class CompanyInfoForAdmin extends AppCompatActivity {
    ...
    private Button approveCompanyButton, deleteCompanyButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_info_for_admin);
        ...
        approveCompanyButton = findViewById(R.id.approve_company_button);
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.open_home_page: {
                    startActivity(new Intent(CompanyInfoForAdmin.this, LoginActivity.class));
                    return true;
                }
        ...
        if (company.isApproved()) {
            approveCompanyButton.setText("Approved");
            approveCompanyButton.setEnabled(false);
            approveCompanyButton.setBackgroundColor(Color.GRAY);
        }

        deleteCompanyButton.setOnClickListener(v -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(CompanyInfoForAdmin.this);
            ...
            builder.setPositiveButton("Yes", (dialog, which) -> {
                databaseReference.child(key).removeValue().addOnSuccessListener(unused -> {
                    Toast.makeText(CompanyInfoForAdmin.this, "Company deleted successfully", Toast.LENGTH_SHORT).show();
                    FirebaseStorage.getInstance().getReferenceFromUrl(company.getImageUrl()).delete();
                    startActivity(new Intent(CompanyInfoForAdmin.this, ManagerHomePageActivity.class));
                });
            });
        ...
        approveCompanyButton.setOnClickListener(v -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(CompanyInfoForAdmin.this);
            builder.setTitle("Approve Company");
            builder.setMessage("Are you sure you want to approve this company?");
            builder.setPositiveButton("Yes", (dialog, which) -> {
                databaseReference.child(key).child("approved").setValue(true).addOnSuccessListener(unused -> {
                    Toast.makeText(CompanyInfoForAdmin.this, "Company approved successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(CompanyInfoForAdmin.this, AdminHomePageActivity.class));
                });
            });
            builder.setNegativeButton("No", (dialog, which) -> dialog.dismiss());
            builder.create().show();
